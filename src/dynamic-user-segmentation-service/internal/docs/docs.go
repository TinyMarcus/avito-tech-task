...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateOrUpdateSegmentDto"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.UsersActiveSegments"
                        }
                    },
                    "404": {
                        "description": "Пользователь с данным идентификатором не найден",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ChangeUserSegmentsDto"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "models.ChangeUserSegmentsDto": {
            ...
            "properties": {
                "add_to_user": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SegmentWithDeadlineDate"
                    }
                },
                "take_from_user": {
        ...
        "models.CreateOrUpdateSegmentDto": {
        ...
        "models.SegmentWithDeadlineDate": {
